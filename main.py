...
while tryAnotherPoint:
    ...
    opt = {'maxiter': 1000}
    result = minimize(functionToMinimize, initialPointsGuesses, constraints=CrossFrameConstraints.GetConstraints(polygonLines, listOfPoints, minDistances), options=opt)
    print(result)
