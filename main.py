...
#
#     returnVec.append(CrossFrameOptimizationLibrary.GetPointDistanceFromLine(ClassPoint(optimalPoints[0], optimalPoints[1]), polygonLines[2])
#                      - minDistanceFromLine)
#
#     return returnVec
#
...
#
#     distanceBetweenPoints.append(CrossFrameOptimizationLibrary.distance(point1, currentPoint5) - minDistanceFromCorners)
#     distanceBetweenPoints.append(CrossFrameOptimizationLibrary.distance(point2, currentPoint5) - minDistanceFromCorners)
#     distanceBetweenPoints.append(CrossFrameOptimizationLibrary.distance(point3, currentPoint5) - minDistanceFromCorners)
#
#     if len(optimalPoints) > 9:
#         distanceBetweenPoints.append(CrossFrameOptimizationLibrary.distance(point4, currentPoint5) - minDistanceFromCorners)
#
...
#
#     distanceBetweenPoints.append(CrossFrameOptimizationLibrary.distance(currentPoint6, currentPoint7) - minDistanceBetweenPathNodes)
#     distanceBetweenPoints.append(CrossFrameOptimizationLibrary.distance(currentPoint7, currentPoint8) - minDistanceBetweenPathNodes)
#     distanceBetweenPoints.append(CrossFrameOptimizationLibrary.distance(currentPoint6, currentPoint5) - minDistanceBetweenPathNodes)
#     distanceBetweenPoints.append(CrossFrameOptimizationLibrary.distance(currentPoint7, currentPoint5) - minDistanceBetweenPathNodes)
#     distanceBetweenPoints.append(CrossFrameOptimizationLibrary.distance(currentPoint8, currentPoint5) - minDistanceBetweenPathNodes)
#
#     if len(optimalPoints) > 9:
#         currentPoint9 = ClassPoint(optimalPoints[8], optimalPoints[9])
#
#         distanceBetweenPoints.append(CrossFrameOptimizationLibrary.distance(currentPoint8, currentPoint9) - minDistanceBetweenPathNodes)
#         distanceBetweenPoints.append(CrossFrameOptimizationLibrary.distance(currentPoint9, currentPoint6) - minDistanceBetweenPathNodes)
#         distanceBetweenPoints.append(CrossFrameOptimizationLibrary.distance(currentPoint9, currentPoint5) - minDistanceBetweenPathNodes)
#
#     return distanceBetweenPoints
#
#
...
while tryAnotherPoint:
    ...
    opt = {'maxiter': 1000}
    result = minimize(functionToMinimize, initialPointsGuesses, constraints=CrossFrameConstraints.GetConstraints(), options=opt)
    print(result)
